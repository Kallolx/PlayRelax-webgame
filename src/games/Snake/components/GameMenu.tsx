...
export default function GameMenu({ onStart }: GameMenuProps) {
  ...
  return (
    ...
    >
      <h1 className="text-5xl font-bold text-white mb-4">Snake</h1>
      <p className="text-gray-400 text-lg mb-12">
        Guide the snake to eat food and grow longer while avoiding walls!
      </p>
      ...
      >
        ...
        <span>Start {selectedMode === 'classic' ? 'Classic' : selectedMode === 'speed' ? 'Speed Run' : 'Time Trial'}</span>
      </motion.button>
    </motion.div>
  );
} 